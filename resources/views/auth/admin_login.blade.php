...
<head>
  <meta charset="utf-8">
    ...
    <title>Đăng nhập - Quản lý Shop </title>
							...
							<form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="email" name="email" type="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
							...
							@endif
								  ...
								  <div class="row">
									...
									<div class="col-12 text-center">
									  <button type="submit" class="btn btn-info btn-rounded mt-10">ĐĂNG NHẬP</button>
									</div>
									<!-- /.col -->
								  </div>
							</form>														
