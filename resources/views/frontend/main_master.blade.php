    ...
    <div class="modal-dialog">
        ...
        <div class="col-md-4">
            <ul class="list-group">
                ...
                <li class="list-group-item">Nhãn hiệu: <strong id="pbrand"></strong></li>
                <li class="list-group-item">Kho: <span class="badge badge-pill badge-success" id="aviable" style="background: green; color: white;"></span> 
        ...
        <div class="col-md-4">
            ...
            <button type="submit" class="btn btn-primary mb-2" onclick="addToCart()" >Thêm giỏ hàng</button>
        </div><!-- // end col md -->
        @else
        <div class="col-md-4">
            <ul class="list-group">
...
function productViewvn(id){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            // Color
    $('select[name="color"]').empty();        
    $.each(data.color1,function(key,value){
        $('select[name="color"]').append('<option value=" '+value+' ">'+value+' </option>')
    }) // end color

     // Size
    $('select[name="size"]').empty();        
    $.each(data.size1,function(key,value){
        $('select[name="size"]').append('<option value=" '+value+' ">'+value+' </option>')
        if (data.size == "") {
            $('#sizeArea').hide();
        }else{
