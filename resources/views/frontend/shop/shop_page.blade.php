        ...
        <div class="sidebar-module-container">
          <div class="sidebar-filter"> 
            ...
            <div class="sidebar-widget wow fadeInUp">
              <h3 class="section-title">Mua sắm với </h3>
...
<!--  /////////// This is for Brand Filder /////////////// -->
 ...
 <div class="widget-header">
                <h4 class="widget-title">Tìm theo thương hiệu</h4>
              </div>
              <div class="sidebar-widget-body">
                <div class="accordion">
          ...
          {{-- <div class="item">
            ...
            <div class="container-fluid">
              <div class="caption vertical-top text-left">
                <div class="big-text"> Giám giá lớn </div>
                <div class="excerpt hidden-sm hidden-md"> Giảm tới 49% </div>
          ...
          <div class="action">
            <ul class="list-unstyled">
              <li class="add-cart-button btn-group">
                <button class="btn btn-primary icon" type="button" data-toggle="modal" data-target="#exampleModal" id="{{ $product->id }}" onclick="productViewvn(this.id)"> <i class="fa fa-shopping-cart"></i> </button>   <button class="btn btn-primary cart-btn" type="button">Add to cart</button>
              </li>
