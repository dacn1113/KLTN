...
<div class="container-full">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Trang cài đặt trang web </h4>
	 ...
	 <div class="form-group">
		<h5>Logo trang web  <span class="text-danger"> </span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Điện thoại một <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Điện thoại hai <span class="text-danger">*</span></h5>
		<div class="controls">
...
<div class="form-group">
		<h5>Tên công ty<span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Địa chỉ công ty <span class="text-danger">*</span></h5>
		<div class="controls">
