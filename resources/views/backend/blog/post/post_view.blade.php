		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Thêm Blog</h4>
...
<div class="row"> <!-- start 8th row  -->
	    ...
	    <div class="form-group">
			<h5>Bài viết En<span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea id="editor1" name="post_details_en" rows="10" cols="80" required="">
		Nhập
	     ...
	     <div class="form-group">
			<h5>Bài viết Vn <span class="text-danger">*</span></h5>
			<div class="controls">
...
<input type="submit" class="btn btn-rounded btn-primary mb-5" value="Tạo Blog">
						</div>
					</form>
